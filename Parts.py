...
all_back_weapons = (
    ...
    Back_Weapon(0x65, "WM-X5-AA", "BOMB DISPENSER", 19300, 616, 85, "NONE", "NONE", 675, 10, "SOLID", 270, 0, 0, 50, True, 2), #Drops 8 ground-attack mines. For experts.
    Back_Weapon(0x66, "WM-X10", "BOMB DISPENSER", 24800, 939, 105, "NONE", "NONE", 675, 10, "SOLID", 560, 0, 0, 50, True, 2), #Drops 16 powerful ground-attack mines.
...
all_arm_weapon_r = (
    Arm_Weapon_R(0x7F, "NO WEAPON", "- - - - - - - -", 0, 0, 0, "WIDE & SHALLOW", 0, 0, "- - - - - -", 0, 0, 0, 0, 5), #
    Arm_Weapon_R(0x80, "WG-RF35", "RIFLE", 11400, 415, 6, "WIDE & SHALLOW", 218, 200, "SOLID", 18, 8500, 1, 5, 1), #Standard portable rifle. Suitable for various missions.
    Arm_Weapon_R(0x81, "WG-MGA1", "MACHINE GUN", 14000, 370, 4, "WIDE & SHALLOW", 85, 500, "SOLID", 9, 6300, 1, 1, 1), #Fast-reloading solid round machine gun. Low single-round firepower.
    Arm_Weapon_R(0x82, "WG-MG500", "MACHINE GUN", 28400, 458, 4, "WIDE & SHALLOW", 135, 500, "SOLID", 15, 7800, 1, 2, 2), #Enhanced version of the machine gun with higher firepower.
    Arm_Weapon_R(0x83, "WG-AR1000", "MACHINE GUN", 42300, 516, 8, "SPECIAL", 105, 1000, "SOLID", 12, 7000, 1, 1, 3), #Most powerful portable type machine gun.
    Arm_Weapon_R(0x84, "WG-HG235", "HAND GUN", 19000, 170, 22, "WIDE & SHALLOW", 226, 100, "SOLID", 68, 4800, 1, 5, 1), #Wide scatter-shot pistol. Very short range.
    ...
    Arm_Weapon_R(0x8C, "WG-XP2000", "PULSE RIFLE", 61500, 265, 285, "SPECIAL", 435, 200, "ENERGY", 0, 18000, 1, 6, 2), #Energy weapon. Emphasizes its long range and number of shots.
...
Arm_Weapon_L_by_tier = {
    1: [Arm_Weapon_L for Arm_Weapon_L in all_arm_weapon_l if Arm_Weapon_L.tier == 1],
    2: [Arm_Weapon_L for Arm_Weapon_L in all_arm_weapon_l if Arm_Weapon_L.tier == 2],
    3: [Arm_Weapon_L for Arm_Weapon_L in all_arm_weapon_l if Arm_Weapon_L.tier == 3],
}


#all_parts: typing.Tuple[Part, ...] = all_heads + all_cores + all_legs + all_arms + all_arm_weapon_r + all_back_weapons + all_arm_weapon_l + all_boosters + all_fcs + all_generators + all_options_parts
#all_parts_data_order: typing.Tuple[Part, ...] = all_heads + all_cores + all_arms + all_legs + all_generators + all_fcs + all_options_parts + all_boosters + all_back_weapons + all_arm_weapon_r + all_arm_weapon_l
